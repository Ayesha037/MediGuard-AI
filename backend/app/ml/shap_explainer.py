...
def _humanize(feature: str, value: float, impact: float) -> str:
...
class ShapExplainer:
    ...
    def top_reasons(self, feature_row: pd.Series, top_k: int = 5) -> list[dict]:
        ...
        for feature, impact in risk_increasing:
            ...
            results.append({
                ...
                "explanation": _humanize(feature, value, impact),
            })
        return results
